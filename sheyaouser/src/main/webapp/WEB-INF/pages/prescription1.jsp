...
%>
	<style>
		...
		.subNav {
			...
			line-height: 28px;
			padding-left: 10px;
			background: url(/sheyaouser/staticfile/assets/images/jiantou1.jpg) no-repeat;
		...
		.currentDt {
			background-image: url(/sheyaouser/staticfile/assets/images/jiantou.jpg);
		}
			...
			<div class="input-group custom-search-form" style="margin-left: 20px;margin-right: 20px;">
			 ...
			 <script type="text/javascript">
              function check(){ 
            	...
            	window.location.href ='/sheyaouser/Prescription_more?key='+key;
            	}
