...
<style>
		...
		.subNav {
			...
			line-height: 28px;
			padding-left: 10px;
			background: url(/sheyaouser/staticfile/images/jiantou1.jpg) no-repeat;
		...
		.currentDt {
			background-image: url(/sheyaouser/staticfile/images/jiantou.jpg);
		}
				...
				<div class="collapse navbar-collapse noPadding" id="myNavbar">
					<div class="navbar-right menustyle">
						<ul class="nav navbar-nav">
							<li>
								<a href="/sheyaouser/toMedicine">
									<p>药</p>
								</a>
							</li>
							<li>
								<a href="/sheyaouser/toPrescription">
									<p>方</p>
								</a>
							</li>
							<li>
								<a href="/sheyaouser/toDoctor">
									<p>医</p>
								</a>
							</li>
							<li>
								<a href="/sheyaouser/toStatistics">
									<p>统</p>
								</a>
							</li>
						</ul>
...
<!--               </form>  -->
              ...
              function check(){ 
            	...
            	window.location.href ='/sheyaouser/Querykey?key='+key;
            	}
	...
	Medicine m =medicine_more.get(i);%>
					...
					<div class="col-sm-6 col-md-4">
						<a href="QueryById?id=<%=m.getMedicine_ID()%>">
							<div class="thumbnail">
								<img src="/sheyaoImg/<%=m.getMedicine_plantImg()%>">
								<div class="caption">
